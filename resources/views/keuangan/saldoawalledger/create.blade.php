<form action="{{ route('saldoawalledger.store') }}" id="formSaldoawalledger" method="POST">
    @csrf
    ...
    <div class="row mb-3">
        <div class="col-lg-8 col-md-12 col-sm-12">
            <x-input-with-icon label="Jumlah" name="jumlah" icon="ti ti-moneybag" textalign="right" />
        </div>
...
<script>
    $(function() {
        ...
        form.find("#kode_ledger,#bulan,#tahun").change(function() {
        ...
        $("#getsaldo").click(function() {
            ...
            const kode_ledger = form.find("#kode_ledger").val();
            if (bulan == "") {
                Swal.fire({
                    title: "Oops!",
