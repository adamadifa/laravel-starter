<form action="{{ route('jenissimpanan.store') }}" id="formSimpanan" method="POST">
    @csrf
    <x-input-with-icon icon="ti ti-barcode" label="Kode Jenis Simpanan" name="kode_simpanan" />
    <x-input-with-icon icon="ti ti-file-description" label="Jenis Simpanan" name="jenis_simpanan" />
