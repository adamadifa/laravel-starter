...
@section('content')
    <div id="section-header">
        ...
        <div id="section-saldo" class="mt-5  text-center">
            <h1 class="fw-bold text-white mb-3" style="line-height: 0px; font-size:60px" id="saldo">{{ formatAngka($saldo_tabungan->saldo) }}</h1>
            <span class="text-white">Saldo {{ $saldo_tabungan->jenis_tabungan }}</span>
        </div>
    </div>
