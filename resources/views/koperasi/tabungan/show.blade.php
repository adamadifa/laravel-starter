        ...
        <div class="card mb-4">
            <div class="user-profile-header-banner">
                ...
                <h2 style="position: absolute; top: 30%; left: 50%; transform: translate(-50%, -50%);" class="text-white text-center">
                    {{ $tabungan->kode_tabungan }} - Tabungan {{ $tabungan->jenis_tabungan }}
                    <br>
                    <sup>Rp. </sup>{{ formatRupiah($tabungan->saldo) }}
                </h2>
            </div>
                    ...
                    <div
                        ...
                        <div class="user-profile-info">
                            ...
                            <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                                ...
                                <li class="list-inline-item d-flex gap-1">
                                    <i class="ti ti-credit-card"></i> {{ textCamelCase($tabungan->no_rekening) }}
                                </li>
                                <li class="list-inline-item d-flex gap-1">
                                    <i class="ti ti-file-description"></i> {{ textCamelCase($tabungan->jenis_tabungan) }}
                                </li>
                            </ul>
                        </div>
