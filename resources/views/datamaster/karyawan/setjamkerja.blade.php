<div class="row">
    <div class="col">
        <table class="table">
            <tr>
                <th>NPP</th>
                <td class="text-end">{{ $karyawan->npp }}</td>
            </tr>
            <tr>
                <th>Nama</th>
                <td class="text-end">{{ $karyawan->nama_lengkap }}</td>
            </tr>
        </table>
        ...
        <div class="nav-align-top  mb-6">
            ...
            <div class="tab-content">
                <div class="tab-pane fade active show" id="navs-top-home" role="tabpanel">
                    <form action="{{ route('karyawan.storejamkerjabyday', Crypt::encrypt($karyawan->npp)) }}" id="formSetJamkerja" method="POST">
                        @csrf
                    ...
                    respond.map((d) => {
                        ...
                        $(document).find("#getjamkerjabydate").append(`
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="deletejamkerjabydate" tanggal="${d.tanggal}" npp="${d.npp}">
